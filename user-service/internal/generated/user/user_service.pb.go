...
func (x *CreateUserRequest) GetTgUserId() int64 {
	if x != nil {
		return x.TgUserId
	}
	return 0
...
func (x *GetUserRequest) GetTgUserId() int64 {
	if x != nil {
		return x.TgUserId
	}
	return 0
...
type UserResponse struct {
	...
	TgUserId      int64                  `protobuf:"varint,3,opt,name=tg_user_id,json=tgUserId,proto3" json:"tg_user_id,omitempty"`
...
func (x *UserResponse) GetTgUserId() int64 {
	if x != nil {
		return x.TgUserId
	}
	return 0
...
var file_proto_user_service_proto_rawDesc = string([]byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x74, 0x67, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64,
	...
	0x03, 0x52, 0x08, 0x74, 0x67, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x39, 0x0a, 0x0a, 0x63,
